...
```html
<div style="width:794px;height:1123px;position:relative;overflow:hidden;background:var(--card_bg);font-family:Montserrat, Arial, 'PingFang SC', 'Microsoft YaHei', sans-serif;">
