...
```html
<div style="width:794px;height:1123px;position:relative;overflow:hidden;background:var(--primary);font-family:'JetBrains Mono','PingFang SC','Microsoft YaHei',sans-serif;">
