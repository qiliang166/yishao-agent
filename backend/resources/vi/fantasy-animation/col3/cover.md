...
```html
<div style="width:794px;height:1123px;display:flex;flex-direction:column;background:var(--primary);font-family:Quicksand, Arial, 'PingFang SC', 'Microsoft YaHei', sans-serif;position:relative;overflow:hidden;">
  ...
  <div style="flex-shrink:0;height:480px;display:flex;flex-direction:column;justify-content:flex-end;text-align:center;">
    <div style="font-size:56px;font-weight:700;color:#ffffff;letter-spacing:3px;padding:0 60px;font-family:'DM Sans',Quicksand, Arial, 'PingFang SC', 'Microsoft YaHei', sans-serif;">{{TITLE}}</div>
