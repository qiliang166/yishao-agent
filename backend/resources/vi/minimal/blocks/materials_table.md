...
```html
<div style="width:794px;height:1123px;display:flex;flex-direction:column;background:var(--background);font-family:Work Sans, Inter, 'PingFang SC', 'Microsoft YaHei', sans-serif;position:relative;overflow:hidden;">
  ...
  <div style="flex:1;position:relative;overflow:hidden;">
    ...
    <table style="width:100%;border-collapse:collapse;font-size:12px;font-family:Work Sans, Inter, 'PingFang SC', 'Microsoft YaHei', sans-serif;">
      <colgroup>
