...
```html
<div style="width:794px;height:1123px;display:flex;flex-direction:column;background:var(--card_bg);font-family:Kalam, 'PingFang SC', 'Microsoft YaHei', cursive;position:relative;overflow:hidden;">
