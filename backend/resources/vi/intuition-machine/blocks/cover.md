...
```html
<div style="width:794px;height:1123px;position:relative;overflow:hidden;background:var(--primary);font-family:Space Grotesk, Space Grotesk, Inter, 'PingFang SC', 'Microsoft YaHei', sans-serif;">
