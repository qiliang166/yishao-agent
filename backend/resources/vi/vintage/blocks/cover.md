...
```html
<div style="width:794px;height:1123px;position:relative;overflow:hidden;background:var(--card_bg);font-family:'Playfair Display',Georgia,'Times New Roman','Noto Serif SC','STSong',serif;">
