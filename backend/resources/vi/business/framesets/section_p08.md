# 框架 section_p08（页型：section）— 真实 PPT 提取，几何锁死
...
| 占位符 | 用途 | 字号 | 示例 |
|--------|------|------|------|
| `{{hero_numeral#0}}` | 大号数字 | fs=80.0 | 例：CHAPTER 02 |
| `{{section_title#0}}` | 章节大标题 | fs=36.0 | 例：术 — 操作技法与通用流程 |
| `{{lead_text#0}}` | 引导句/小标题 | fs=18.0 | 例：六艺操作参数 × 可复用通用流程 × 常 |
| `{{footnote#0}}` | 脚注 | fs=14.0 | 例：第二章 / 共二章 |
