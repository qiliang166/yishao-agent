...
def init_db():
    ...
    try:
        ...
        # Seed 10 preset PPT styles from guizang themes (2026-06-24)
        try:
            import json as _json
            existing_tpls = conn.execute("SELECT COUNT(*) FROM templates WHERE type='preset'").fetchone()[0]
            if existing_tpls == 0:
                _presets = [
                    # ── Magazine styles (5 from themes.md) ──
                    ('preset-ink-classic', '\U0001f58b 墨水经典', 'preset',
                     'backend/services/ppt_engine/assets/template.html',
                     '', '',
                     _json.dumps({"design_rules":{"style_family":"magazine",
                      "colors":{"primary":"#0a0a0b","ink":"#0a0a0b","ink_rgb":"10,10,11",
                       "paper":"#f1efea","paper_rgb":"241,239,234","paper_tint":"#e8e5de",
                       "ink_tint":"#18181a","accent":"#0a0a0b","background":"#f1efea"},
                      "fonts":{"title":"微软雅黑","body":"微软雅黑","title_size":"36pt","body_size":"18pt"},
                      "spacing":{"margin_top":1.5,"margin_bottom":1.5,"margin_left":2.0,"margin_right":2.0,
                       "line_height":1.2}},
                      "layout_types":[{"id":"cover","name":"封面","zones":["title","subtitle"]},
                       {"id":"toc","name":"目录","zones":["heading","items"]},
                       {"id":"content","name":"内容","zones":["heading","body"]},
                       {"id":"summary","name":"总结","zones":["review","key_points"]}]},
                     ensure_ascii=False),
                     '', '', '', 0, '', ''),
                    ('preset-indigo', '\U0001f30a 靛蓝瓷', 'preset',
                     'backend/services/ppt_engine/assets/template.html',
                     '', '',
                     _json.dumps({"design_rules":{"style_family":"magazine",
                      "colors":{"primary":"#0a1f3d","ink":"#0a1f3d","ink_rgb":"10,31,61",
                       "paper":"#f1f3f5","paper_rgb":"241,243,245","paper_tint":"#e4e8ec",
                       "ink_tint":"#152a4a","accent":"#0a1f3d","background":"#f1f3f5"},
                      "fonts":{"title":"微软雅黑","body":"微软雅黑","title_size":"36pt","body_size":"18pt"},
                      "spacing":{"margin_top":1.5,"margin_bottom":1.5,"margin_left":2.0,"margin_right":2.0,
                       "line_height":1.2}},
                      "layout_types":[{"id":"cover","name":"封面","zones":["title","subtitle"]},
                     ...
                     ensure_ascii=False),
                     '', '', '', 0, '', ''),
                    ('preset-forest', '\U0001f33f 森林墨', 'preset',
                     'backend/services/ppt_engine/assets/template.html',
                     '', '',
                     _json.dumps({"design_rules":{"style_family":"magazine",
                      "colors":{"primary":"#1a2e1f","ink":"#1a2e1f","ink_rgb":"26,46,31",
                       "paper":"#f5f1e8","paper_rgb":"245,241,232","paper_tint":"#ece7da",
                       "ink_tint":"#253d2c","accent":"#1a2e1f","background":"#f5f1e8"},
                      "fonts":{"title":"微软雅黑","body":"微软雅黑","title_size":"36pt","body_size":"18pt"},
                      "spacing":{"margin_top":1.5,"margin_bottom":1.5,"margin_left":2.0,"margin_right":2.0,
                       "line_height":1.2}},
                      "layout_types":[{"id":"cover","name":"封面","zones":["title","subtitle"]},
                     ...
                     ensure_ascii=False),
                     '', '', '', 0, '', ''),
                    ('preset-kraft', '\U0001f342 牛皮纸', 'preset',
                     'backend/services/ppt_engine/assets/template.html',
                     '', '',
                     _json.dumps({"design_rules":{"style_family":"magazine",
                      "colors":{"primary":"#2a1e13","ink":"#2a1e13","ink_rgb":"42,30,19",
                       "paper":"#eedfc7","paper_rgb":"238,223,199","paper_tint":"#e0d0b6",
                       "ink_tint":"#3a2a1d","accent":"#2a1e13","background":"#eedfc7"},
                      "fonts":{"title":"微软雅黑","body":"微软雅黑","title_size":"36pt","body_size":"18pt"},
                      "spacing":{"margin_top":1.5,"margin_bottom":1.5,"margin_left":2.0,"margin_right":2.0,
                       "line_height":1.2}},
                      "layout_types":[{"id":"cover","name":"封面","zones":["title","subtitle"]},
                     ...
                     ensure_ascii=False),
                     '', '', '', 0, '', ''),
                    ('preset-dune', '\U0001f319 沙丘', 'preset',
                     'backend/services/ppt_engine/assets/template.html',
                     '', '',
                     _json.dumps({"design_rules":{"style_family":"magazine",
                      "colors":{"primary":"#1f1a14","ink":"#1f1a14","ink_rgb":"31,26,20",
                       "paper":"#f0e6d2","paper_rgb":"240,230,210","paper_tint":"#e3d7bf",
                       "ink_tint":"#2d2620","accent":"#1f1a14","background":"#f0e6d2"},
                      "fonts":{"title":"微软雅黑","body":"微软雅黑","title_size":"36pt","body_size":"18pt"},
                      "spacing":{"margin_top":1.5,"margin_bottom":1.5,"margin_left":2.0,"margin_right":2.0,
                       "line_height":1.2}},
                      "layout_types":[{"id":"cover","name":"封面","zones":["title","subtitle"]},
                     ...
                     ensure_ascii=False),
                     '', '', '', 0, '', ''),
                    # ── Swiss styles (4 from themes-swiss.md) ──
                    ('preset-ikb', '\U0001f535 克莱因蓝', 'preset',
                     'backend/services/ppt_engine/assets/template-swiss.html',
                     '', '',
                     _json.dumps({"design_rules":{"style_family":"swiss",
                      "colors":{"primary":"#002FA7","ink":"#0a0a0a","ink_rgb":"10,10,10",
                       "paper":"#fafaf8","paper_rgb":"250,250,248",
                       "grey_1":"#f0f0ee","grey_2":"#d4d4d2","grey_3":"#737373",
                       "accent":"#002FA7","accent_rgb":"0,47,167","accent_on":"#ffffff",
                       "background":"#fafaf8"},
                      "fonts":{"title":"微软雅黑","body":"微软雅黑","title_size":"36pt","body_size":"18pt"},
                      "spacing":{"margin_top":1.0,"margin_bottom":1.0,"margin_left":1.5,"margin_right":1.5,
                       "line_height":1.3}},
                      "layout_types":[{"id":"cover","name":"封面","zones":["title","subtitle","date"]},
                       {"id":"chapter","name":"章节过渡","zones":["number","heading"]},
                       {"id":"toc","name":"目录","zones":["heading","items"]},
                       {"id":"data_hero","name":"大字数据","zones":["big_number","label","context"]},
                       {"id":"timeline","name":"时间轴","zones":["events"]},
                       {"id":"duo_compare","name":"双栏对比","zones":["heading","left","right"]},
                       {"id":"process_flow","name":"流程步骤","zones":["heading","steps"]},
                       {"id":"grid_cards","name":"卡片网格","zones":["heading","cards"]},
                       {"id":"image_hero","name":"全幅图片","zones":["image","caption"]},
                       {"id":"closing","name":"封底","zones":["quote","signature"]}]},
                     ensure_ascii=False),
                     '', '', '', 0, '', ''),
                    ('preset-lemon-yellow', '\U0001f7e1 柠檬黄', 'preset',
                     'backend/services/ppt_engine/assets/template-swiss.html',
                     '', '',
                     _json.dumps({"design_rules":{"style_family":"swiss",
                      "colors":{"primary":"#FFD500","ink":"#0a0a0a","ink_rgb":"10,10,10",
                       "paper":"#fafaf8","paper_rgb":"250,250,248",
                       "grey_1":"#f0f0ee","grey_2":"#d4d4d2","grey_3":"#737373",
                       "accent":"#FFD500","accent_rgb":"255,213,0","accent_on":"#0a0a0a",
                       "background":"#fafaf8"},
                      "fonts":{"title":"微软雅黑","body":"微软雅黑","title_size":"36pt","body_size":"18pt"},
                      "spacing":{"margin_top":1.0,"margin_bottom":1.0,"margin_left":1.5,"margin_right":1.5,
                       "line_height":1.3}},
                     ...
                     ensure_ascii=False),
                     '', '', '', 0, '', ''),
                    ('preset-lemon-green', '\U0001f7e2 柠檬绿', 'preset',
                     'backend/services/ppt_engine/assets/template-swiss.html',
                     '', '',
                     _json.dumps({"design_rules":{"style_family":"swiss",
                      "colors":{"primary":"#C5E803","ink":"#0a0a0a","ink_rgb":"10,10,10",
                       "paper":"#fafaf8","paper_rgb":"250,250,248",
                       "grey_1":"#f0f0ee","grey_2":"#d4d4d2","grey_3":"#737373",
                       "accent":"#C5E803","accent_rgb":"197,232,3","accent_on":"#0a0a0a",
                       "background":"#fafaf8"},
                      "fonts":{"title":"微软雅黑","body":"微软雅黑","title_size":"36pt","body_size":"18pt"},
                      "spacing":{"margin_top":1.0,"margin_bottom":1.0,"margin_left":1.5,"margin_right":1.5,
                       "line_height":1.3}},
                     ...
                     ensure_ascii=False),
                     '', '', '', 0, '', ''),
                    ('preset-safety-orange', '\U0001f7e0 安全橙', 'preset',
                     'backend/services/ppt_engine/assets/template-swiss.html',
                     '', '',
                     _json.dumps({"design_rules":{"style_family":"swiss",
                      "colors":{"primary":"#FF6B35","ink":"#0a0a0a","ink_rgb":"10,10,10",
                       "paper":"#fafaf8","paper_rgb":"250,250,248",
                       "grey_1":"#f0f0ee","grey_2":"#d4d4d2","grey_3":"#737373",
                       "accent":"#FF6B35","accent_rgb":"255,107,53","accent_on":"#ffffff",
                       "background":"#fafaf8"},
                      "fonts":{"title":"微软雅黑","body":"微软雅黑","title_size":"36pt","body_size":"18pt"},
                      "spacing":{"margin_top":1.0,"margin_bottom":1.0,"margin_left":1.5,"margin_right":1.5,
                       "line_height":1.3}},
                     ...
                     ensure_ascii=False),
                     '', '', '', 0, '', ''),
                    # ── KIMI Midnight Blue+Copper ──
                    ('preset-kimi-midnight', '\U0001f31c KIMI 午夜蓝铜', 'preset',
                     'backend/services/ppt_engine/assets/template-swiss.html',
                     '', '',
                     _json.dumps({"design_rules":{"style_family":"swiss",
                      "colors":{"primary":"#1a1a2e","ink":"#e0d8c8","ink_rgb":"224,216,200",
                       "paper":"#1a1a2e","paper_rgb":"26,26,46",
                       "grey_1":"#252540","grey_2":"#3d3d56","grey_3":"#8a8a9a",
                       "accent":"#c9a96e","accent_rgb":"201,169,110","accent_on":"#1a1a2e",
                       "background":"#1a1a2e"},
                      "fonts":{"title":"微软雅黑","body":"微软雅黑","title_size":"36pt","body_size":"18pt"},
                      "spacing":{"margin_top":1.0,"margin_bottom":1.0,"margin_left":1.5,"margin_right":1.5,
                       "line_height":1.3}},
