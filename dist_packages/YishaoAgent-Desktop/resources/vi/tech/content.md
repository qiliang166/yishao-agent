...
- **标题**: 36-44px, primary `{{primary}}`, Space Grotesk, font-weight:700
- **标题下方**: accent 短线 40×3px `{{accent}}`
- **内容区**: 占画布 55-70%
- **页码**: 右下角 dot(6px `{{accent}}`) + 当前页/总页数，14px 'JetBrains Mono'
...
| 标题字号 | 22-24px, primary `{{primary}}`, Space Grotesk, font-weight:600 |
| 正文字号 | 16-18px, text `{{/*text}}`, JetBrains Mono, line-height:1.6-1.8 |
