...
- 标签 12px 'Source Sans Pro'

## 环形图（Donut）

### 单段环形图（单值占比）
- 中心文字 17px, primary `{{primary}}`, 加粗 700
...
<svg width="180" height="180" viewBox="0 0 180 180">
  ...
  <!-- 中心文字 -->
  <text x="90" y="85" font-size="12px" fill="var(--text)" opacity="0.5" text-anchor="middle">占比</text>
  <text x="90" y="106" font-size="18px" fill="var(--primary)" font-weight="700" text-anchor="middle">35%</text>
</svg>
```
...
<svg width="180" height="180" viewBox="0 0 180 180">
  ...
  <circle cx="90" cy="90" r="65" fill="none" stroke="var(--chart_4)" stroke-width="14"
    ...
    transform="rotate(-90 90 90)" />
  <!-- 中心文字 -->
  <text x="90" y="85" font-size="12px" fill="var(--text)" opacity="0.5" text-anchor="middle">食材占比</text>
  <text x="90" y="106" font-size="18px" fill="var(--primary)" font-weight="700" text-anchor="middle">100%</text>
</svg>
```
...
## 进度条（Progress Bar）
- 轨道: card_bg `{{card_bg}}`
- 填充: chart_color → secondary 纯色（禁用渐变）
- 圆角: 6px（同卡片 token）

## Big Number（大数字）
- 居中 52px 'Source Sans Pro' 加粗 + 单位 17px + 标签 12px opacity 0.6
- 颜色使用 chart_color
