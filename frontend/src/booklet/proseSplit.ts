...
.bkr-host .bk-prose hr { border: none; border-top: 1px solid var(--text); opacity: 0.25; margin: 6mm 0; }
`
...
export function themeVars(theme?: Theme | null): Record<string, string> {
  ...
  return {
    ...
    '--chart-3': c['chart-3'] || c.accent,
    '--chart-4': c['chart-4'] || c.accent,
    '--chart-5': c['chart-5'] || c.accent,
    '--chart-6': c['chart-6'] || c.accent,
    '--chart-7': c['chart-7'] || c.accent,
  }
}
